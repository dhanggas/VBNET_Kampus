...
Public Class lapPengmabilan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lapPengmabilan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapPengmabilan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapPengmabilan = New lapPengmabilan
        rpt.Site = Me.Site
        Return rpt
    End Function
