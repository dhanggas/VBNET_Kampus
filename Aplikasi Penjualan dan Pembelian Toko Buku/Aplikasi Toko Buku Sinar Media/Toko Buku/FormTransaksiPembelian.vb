...
Public Class FormTransaksiPembelian
    ...
    Private Sub Auto()
        ...
        StrSQL = "Select Max(Kd_Pembelian) As Maximum, Count(Kd_Pembelian) As Jumlah from T_PEMBELIAN"
    ...
    Private Sub SimpanPembelian()
        ...
        If Not KodeAuto.Length = 0 Then
            ...
            QInsert = " INSERT INTO T_PEMBELIAN " _
                    & " (Kd_Pembelian, " _
                    & " Tgl_Pembelian, " _
                    & " Kd_Suplier, " _
                    & " Total, " _
            ...
            For i As Integer = 0 To ListView1.Items.Count - 1
                ...
                QInsertDetail = " INSERT INTO T_PEMBELIAN_DETAIL " _
                            & "(Kd_Pembelian, " _
                            & " Kd_Barang, " _
                            & " Qty, " _
                            & " Harga_Beli, " _
            ...
            Next
        End If
        MessageBox.Show("Data Pembelian Telah Tersimpan Dengan Kode Transaksi " & KodeAuto & "", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Call ClearText()
    End Sub


    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        If TxtKdSupplier.TextLength = 0 Then
            MessageBox.Show("Data Supplier Masih Kosong, Silahkan diisi dengan jelas", "Perhatian", _
            MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TxtKdSupplier.Focus()
            Exit Sub
        ElseIf Trim(ListView1.Items.Count) = 0 Then
            ...
            TxtKdBarang.Focus()
            Exit Sub
        ElseIf CDbl(TxtPotongan.Text) >= CDbl(TxtTotal.Text) Then
            MessageBox.Show("Potongan tidak boleh lebih besar dari pada total", "Perhatian..", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TxtPotongan.Focus()
            Exit Sub
        Else
    ...
    Private Sub BtInsertToList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtInsertToList.Click
        ...
        If TxtKdBarang.Text = "" Or TxtKdBarang.Text.Length = 0 Then
            TxtKdBarang.Focus()
            Exit Sub
        ElseIf TxtJumlah.Text = "" Or TxtJumlah.Text.Length = 0 Then
            TxtJumlah.Focus()
            Exit Sub
        Else
    ...
    Private Sub BtRemoveFromList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtRemoveFromList.Click
        ...
        If KdBarang.Length = 0 Then
            BtRemoveFromList.Enabled = False
        Else
            BtRemoveFromList.Enabled = True
        End If
    ...
    Private Sub TxtKdBarang_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtKdBarang.TextChanged
        ...
        If reader.Read Then
            ...
            TxtStok.Text = CDbl(reader.Item("Stock").ToString)
            TxtHarga.Text = "0"
            TxtJumlah.Text = ""
            TxtHarga.Focus()
        Else
    ...
    Private Sub TxtKdSupplier_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtKdSupplier.TextChanged
        TxtKdSupplier.CharacterCasing = CharacterCasing.Upper

        Dim QSelect As String
        QSelect = " SELECT * " _
                & " FROM T_SUPPLIER " _
                & " WHERE Kd_Supplier = '" & Trim(TxtKdSupplier.Text) & "' "

        Dim cmd As New SqlCommand(QSelect, Koneksi.Koneksi)
        Dim reader As SqlDataReader = cmd.ExecuteReader()
        If reader.Read Then
            TxtNmSupp.Text = reader.Item("Nm_Supplier").ToString
            TxtAlamat.Text = reader.Item("Alamat").ToString
            TxtKdBarang.Focus()
        Else
            TxtNmSupp.Text = ""
            TxtAlamat.Text = ""
    ...
    Private Sub BtFindSupplier_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtFindSupplier.Click
        FormCariSupplier.Show()
    End Sub

    Private Sub FormTransaksiPembelian_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ClearText()
        Auto()
        SetListViewColumn()
        TxtKdSupplier.Focus()
