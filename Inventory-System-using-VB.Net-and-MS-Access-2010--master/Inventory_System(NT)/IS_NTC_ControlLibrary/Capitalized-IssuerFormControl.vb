Public Class Capitalized_IssuerFormControl
    Private stockAccess As New StockAccess
    Private objDataView As DataView
    Private objCurrencyManager As CurrencyManager
    Private dt As DataTable

    Private Sub Capitalized_IssuerFormControl_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    'Query to fill DataGridView for the Capitalized-IssueForm
    Private Sub Query()
        ...
        stockAccess.RunQuery("SELECT [Serial No], STOCK.Item_name, Date_of_used, Quantity, Reason, Quantity_on_hand " & _
                             "FROM CAPITALIZED, STOCK " & _
                             "WHERE CAPITALIZED.Item_name = STOCK.Item_name " & _
                             "ORDER BY [Serial No]")
        ...
        Else
            ...
            GblAccessObject.objDataTableOfCapitalizedIssuerForm = dt
    ...
    Private Sub FillDataGridView()
        grdCapitalizedIssuer.DataSource = objDataView

        grdCapitalizedIssuer.Font = New Font(grdCapitalizedIssuer.DefaultCellStyle.Font.FontFamily, 10, FontStyle.Regular)
        ...
        objColumnHeaderStyle.Font = New Font(grdCapitalizedIssuer.DefaultCellStyle.Font.FontFamily, 9, FontStyle.Bold)
        objColumnHeaderStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
        grdCapitalizedIssuer.ColumnHeadersDefaultCellStyle = objColumnHeaderStyle

        'Declare and set the default rows style
        Dim objAlignRightCellStyle As New DataGridViewCellStyle
        objAlignRightCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        grdCapitalizedIssuer.RowsDefaultCellStyle = objAlignRightCellStyle

        'Declare and set the alternating rows style
        Dim objAlternatingCellStyle As New DataGridViewCellStyle
        objAlternatingCellStyle.BackColor = Color.WhiteSmoke
        grdCapitalizedIssuer.AlternatingRowsDefaultCellStyle = objAlternatingCellStyle

        With grdCapitalizedIssuer
    ...
    Private Sub btnView_Click(sender As Object, e As EventArgs) Handles btnView.Click
        ...
        Else
            ...
            'Set the readonly property of textboxes to false
            ReadOnlyFalse()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        'Add the question
        objStringBuilder1.AppendLine("Do you want to add the following capitalized-issue information?")
        ...
        If MessageBox.Show(objStringBuilder1.ToString, My.Application.Info.Title, _
            ...
            Select Case intDialogResult
                Case DialogResult.Yes
                    AddItemAsCapitalizedAndDeductFromStore()
                  
                Case DialogResult.No
                    AddItemAsCapitalizedAndNonDeductFromStore()
    ...
    Private Sub AddItemAsCapitalizedAndDeductFromStore()
        stockAccess.AddCapitalizedIssuerAndDeductFromStock(cboItemName.Text, dtpDateOfUsed.Value.Date, txtQuantity.Text, txtUsedFor.Text)
        ...
        Dim strExceptionItemAsCapitalizedDetails As String = stockAccess.strExceptionAddItemAsCapitalizedAndDeductFromStock
        If strExceptionItemAsCapitalizedDetails <> "" Then
            MsgBox(strExceptionItemAsCapitalizedDetails)

            'Set strExceptionAddItemAsCapitalizedAndDeductFromStock to nothing
            stockAccess.strExceptionAddItemAsCapitalizedAndDeductFromStock = Nothing
        Else
    ...
    Private Sub AddItemAsCapitalizedAndNonDeductFromStore()
        stockAccess.AddCapitalizedIssuerAndNonDeductFromStock(cboItemName.Text, dtpDateOfUsed.Text, txtQuantity.Text, txtUsedFor.Text)
        ...
        Dim strExceptionItemAsCapitalizedDetails As String = stockAccess.strExceptionAddItemAsCapitalizedAndNonDeductFromStock
        If strExceptionItemAsCapitalizedDetails <> "" Then
            MsgBox(strExceptionItemAsCapitalizedDetails)

            'Set strExceptionAddItemAsCapitalizedAndNonDeductFromStock to nothing
            stockAccess.strExceptionAddItemAsCapitalizedAndNonDeductFromStock = Nothing
        Else
            MessageBox.Show(objStringBuilder.ToString, My.Application.Info.Title, MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If MessageBox.Show(objStringBuilder1.ToString, My.Application.Info.Title, _
            ...
            Select Case intDialogResult
                Case DialogResult.Yes
                    DeleteCapitalizedIssuerAndAddToStock()
                Case DialogResult.No
                    DeleteCapitalizedIssuer()
                Case Else
                    'Do nothing
            End Select
        Else
    ...
    Private Sub DeleteCapitalizedIssuer()
        Dim intPosition As Integer = objCurrencyManager.Position - 1
        If intPosition < 0 Then
            intPosition = 0
        End If

        stockAccess.DeleteCapitalizedIssuerAndDoNotAddToStock(txtItemName.Text, dtpDateOfUsed.Value.Date)
        ...
        Dim strExceptionDeleteCapitalizedIssuer As String = stockAccess.strExceptionDeleteItemAsCapitalizedAndDoNotAddToStock
        If strExceptionDeleteCapitalizedIssuer <> "" Then
            MsgBox(strExceptionDeleteCapitalizedIssuer)

            'Set strExceptionDeleteItemAsCapitalizedAndDoNotAddToStock to nothing
            stockAccess.strExceptionDeleteItemAsCapitalizedAndDoNotAddToStock = Nothing
        Else
    ...
    Private Sub DeleteCapitalizedIssuerAndAddToStock()
        Dim intPosition As Integer = objCurrencyManager.Position - 1
        If intPosition < 0 Then
            intPosition = 0
        End If

        stockAccess.DeleteCapitalizedIssuerAndAddToStock(txtItemName.Text, dtpDateOfUsed.Value.Date, txtQuantity.Text)
        ...
        Dim strExceptionDeleteCapitalizedIssuer As String = stockAccess.strExceptionDeleteItemAsCapitalizedAndAddToStock
        If strExceptionDeleteCapitalizedIssuer <> "" Then
            MsgBox(strExceptionDeleteCapitalizedIssuer)

            'Set strExceptionDeleteItemAsCapitalizedAndAddToStock to nothing
            stockAccess.strExceptionDeleteItemAsCapitalizedAndAddToStock = Nothing
        Else
            MessageBox.Show(objStringBuilder.ToString, My.Application.Info.Title, _
                        MessageBoxButtons.OK, MessageBoxIcon.Information)
            Query()
    ...
    Private Sub grdCapitalizedIssuer_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles grdCapitalizedIssuer.CellClick
        If btnView.Text <> "View" Then
    ...
    Private Sub btnRefresh_Click(sender As Object, e As EventArgs) Handles btnRefresh.Click
        Capitalized_IssuerFormControl_Load(Nothing, Nothing)
    End Sub
